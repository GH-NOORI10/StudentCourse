...
namespace StudentCourse.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Age,Enrolled")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Age,Enrolled")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
